...
class EgoVehicle(Vehicle):
    ...
    def send_vehicle_msgs(self):
	    ...
	    vehicle_info.torque = vehicle_physics.torque_curve[self.i].x
	    vehicle_info.rpm = vehicle_physics.torque_curve[self.i].y
	    self.i = (self.i+1)%(len(vehicle_physics.torque_curve))
