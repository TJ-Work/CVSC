...
class ControlLoss(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        #"static.prop.box01" "static.prop.constructioncone'
        #'static.prop.plasticchair''static.prop.trashcan03''static.prop.advertisement'


        # first_debris = CarlaActorPool.request_new_actor('static.prop.*', self.first_transform)
        # second_debris = CarlaActorPool.request_new_actor('static.prop.*', self.sec_transform)
        # third_debris = CarlaActorPool.request_new_actor('static.prop.*', self.third_transform)
