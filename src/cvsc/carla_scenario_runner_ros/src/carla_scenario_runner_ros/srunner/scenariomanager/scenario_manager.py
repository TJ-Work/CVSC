...
class ScenarioManager(object):
    ...
    def load_scenario(self, scenario):
        ...
        self.scenario = scenario.scenario # this is the Scenario class object defined here
        self.scenario_tree = self.scenario.scenario_tree # 3 children: behavior, timeout, criterion
        ...
        import os
        print(os.getcwd())
        #print("{}".format(py_trees.display.dot_graph(self.scenario_tree).to_string()))
