...
from srunner.scenarios.control_assessment import *
...
SCENARIOS = {
    ...
    "ControlAssessment":CONTROL_ASSESSMENT
}
...
class ScenarioRunner(object):
    ...
    def prepare_ego_vehicles(self, config, wait_for_ego_vehicles=False):
        ...
        if not wait_for_ego_vehicles:
            ...
            print("waiting for ego_vehicles")
            print(config.ego_vehicles[0].rolename)
    ...
    def run(self, args):
        ...
        for _ in range(int(args.repetitions)): # default args.repetitions = 1
            ...
            for config in scenario_configurations:
                ...
                scenario_class = self.get_scenario_class_or_fail(config.type) # the result is a basic_scenario class
                try:
